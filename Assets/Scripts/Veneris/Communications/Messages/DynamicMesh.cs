...
public struct DynamicMesh : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static DynamicMesh GetRootAsDynamicMesh(ByteBuffer _bb) { return GetRootAsDynamicMesh(_bb, new DynamicMesh()); }
  public static DynamicMesh GetRootAsDynamicMesh(ByteBuffer _bb, DynamicMesh obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p.bb_pos = _i; __p.bb = _bb; }
  public DynamicMesh __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static void StartDynamicMesh(FlatBufferBuilder builder) { builder.StartObject(4); }
  ...
  public static Offset<DynamicMesh> EndDynamicMesh(FlatBufferBuilder builder) {
    int o = builder.EndObject();
    return new Offset<DynamicMesh>(o);
  }
  public static void FinishDynamicMeshBuffer(FlatBufferBuilder builder, Offset<DynamicMesh> offset) { builder.Finish(offset.Value); }
  public static void FinishSizePrefixedDynamicMeshBuffer(FlatBufferBuilder builder, Offset<DynamicMesh> offset) { builder.FinishSizePrefixed(offset.Value); }
};
